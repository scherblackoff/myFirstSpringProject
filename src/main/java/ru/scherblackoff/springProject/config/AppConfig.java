package ru.scherblackoff.springProject.config;
...
@Configuration
@EnableJpaRepositories("ru.scherblackoff.springProject.repositories")
@EnableTransactionManagement
@ComponentScan("ru.scherblackoff.springProject")
public class AppConfig {
    ...
    public DataSource getDataSource(){
        ...
        dataSource.setPassword("56260799As");
        return dataSource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManager() {
        ...
        factory.setPackagesToScan("ru.scherblackoff.springProject");
